/* 有機化学 — PWA Service Worker */
const CACHE_NAME = 'yuki-pwa-v1';
const ASSETS = ['./yuki.html', './yuki_manifest.json'];
...
self.addEventListener('fetch', e => {
  ...
  if (req.mode === 'navigate') {
    ...
    e.respondWith((async () => {
      ...
      catch(_) { return (await caches.match(req)) || (await caches.match('./yuki.html')) || new Response('', {status:504}); }
    })());
    return;
  }
